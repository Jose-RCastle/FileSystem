...
public sealed class ExploradorForm : Form
{
    ...
    private void CrearContextos()
    {
        ...
        contextoCarpeta.Items.Add("Abrir", null, (_, _) => AbrirSeleccion()); contextoCarpeta.Items.Add("Nuevo archivo TXT aquí", null, (_, _) => CrearDentro(true)); contextoCarpeta.Items.Add("Nueva carpeta aquí", null, (_, _) => CrearDentro(false)); contextoCarpeta.Items.Add("Renombrar", null, (_, _) => RenombrarSeleccion()); contextoCarpeta.Items.Add("Eliminar", null, (_, _) => EliminarSeleccion()); contextoCarpeta.Items.Add("Propiedades", null, (_, _) => PropiedadesSeleccion());
    }
    ...
    private void RefrescarContenido()
    {
        ...
        foreach (var d in actual.Directorios.OrderBy(x => x.Nombre)) contenido.Items.Add(new ListViewItem([d.Nombre, "Carpeta", "—", "—", d.Creado.ToString("g")], "carpeta") { Tag = d });
